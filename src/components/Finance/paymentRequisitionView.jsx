      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container={true}>
          ...
          <Grid item xs={4}>
            <Grid item>
              <Controller
                render={({ field }) => <DatePicker {...field} sx={{ m: 0.5, maxWidth: 210 }} label="Target Date" />}
                name="target_date"
                control={control}
              />
            </Grid>
            ...
            <Grid item>
              <Controller
                render={({ field }) => <DatePicker {...field} sx={{ m: 0.5, maxWidth: 210 }} label="Approved Date" />}
                name="approved_date"
                control={control}
              />
            </Grid>
            ...
            <Grid item>
              <Controller
                render={({ field }) => <DatePicker {...field} sx={{ m: 0.5, maxWidth: 210 }} label="Update By" />}
                name="update_by"
                control={control}
              />
            </Grid>
            <Grid item>
              <Controller
                render={({ field }) => <DatePicker {...field} sx={{ m: 0.5, maxWidth: 210 }} label="Last Update" />}
                name="last_update"
                control={control}
              />
            </Grid>
            ...
            <Grid item>
              <Controller render={({ field }) => <DatePicker {...field} sx={{ m: 0.5, maxWidth: 210 }} label="Due Date" />} name="due_date" control={control} />
            </Grid>
            <Grid item>
